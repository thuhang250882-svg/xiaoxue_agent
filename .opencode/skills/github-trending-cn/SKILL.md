...
description: "GitHub Trending Monitor. Fetch GitHub trending repos by daily/weekly/monthly period using real GitHub Search API. Use for general GitHub trending, open-source trends, popular repositories, or AI/ML/LLM project leaderboards. Supports language and AI topic filters plus GITHUB_TOKEN. 触发词：GitHub、trending、开源、热门项目、AI 趋势、AI 项目排行榜。"
---

# GitHub Trending CN

获取 GitHub 真实热门项目数据，支持今日 / 本周 / 本月，可按编程语言或 AI 主题过滤。该技能已合并原 `github-ai-trends` 能力。
...
# 本周 AI 热门项目
python3 scripts/github_trending.py --period weekly --topic ai
...
| `--topic` | — | 全部 | 主题过滤；`ai` 会检索 AI、LLM、Agent、RAG 等项目 |
