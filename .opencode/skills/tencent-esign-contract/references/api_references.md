...
```bash
python3 scripts/tencent_esign.py call CreateMiniAppPrepareFlow '{
  "ResourceId": "yDRS4UUgygqdcj56UuO4zjExBQcOiB68",
  "FlowName": "文件名称"
}'
```
...
{
    "Response": {
        "ExpiredOn": 1785489216,
        "FlowId": "",
        "LongUrl": "https://res.ess.tencent.cn/cdn/h5-activity-dev/jump-mp.html?to=CREATE_CONTRACT&shortKey=yD3JmUz7GyzZTQFQsN52",
        "MiniAppPath": "pages/guide/index?to=CREATE_CONTRACT&shortKey=yD3JmUz7GyzZTQFQsN52",
        "RequestId": "s1782897216665589376",
        "ShortUrl": "https://essurl.cn/NlTBUBYoI4"
    }
}
```
