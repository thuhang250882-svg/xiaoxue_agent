export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de 录井小雪",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de 录井小雪. ¿Quieres instalarla y reiniciar?",
