export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av 录井小雪",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av 录井小雪 er lastet ned. Vil du installere den og starte på nytt?",
