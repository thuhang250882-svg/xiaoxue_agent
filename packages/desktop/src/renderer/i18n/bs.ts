export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju 录井小雪-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} 录井小雪-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
