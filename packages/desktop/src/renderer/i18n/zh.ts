export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 录井小雪",
  ...
  "desktop.updater.downloaded.prompt": "已下载 录井小雪 {{version}} 版本，是否安装并重启？",
  "desktop.updater.installFailed.title": "更新失败",
  "desktop.updater.installFailed.message": "无法安装更新",

  "desktop.cli.installed.title": "CLI 已安装",
  "desktop.cli.installed.message": "小雪 CLI 已安装到 {{path}}\n\n重启终端后可使用 'opencode' 命令。",
