export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of 录井小雪 (Xiaoxue)",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of 录井小雪 (Xiaoxue) has been downloaded, would you like to install it and relaunch?",
