export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von 录井小雪",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von 录井小雪 wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
