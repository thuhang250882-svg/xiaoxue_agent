export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af 录井小雪",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af 录井小雪 er blevet downloadet. Vil du installere den og genstarte?",
