export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من 录井小雪",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من 录井小雪، هل ترغب في تثبيته وإعادة تشغيله؟",
