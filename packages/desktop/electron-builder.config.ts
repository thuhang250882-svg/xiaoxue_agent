  ...
  switch (channel) {
    ...
    case "beta": {
      return {
        ...
        protocols: { name: "XiaoXue Beta", schemes: ["xiaoxue"] },
        publish: { provider: "github", owner: "xbzty", repo: "xiaoxue-agent-beta", channel: "latest" },
    ...
    case "prod": {
      return {
        ...
        appId,
        productName: "录井小雪",
        protocols: { name: "XiaoXue", schemes: ["xiaoxue"] },
        publish: { provider: "github", owner: "xbzty", repo: "xiaoxue-agent", channel: "latest" },
