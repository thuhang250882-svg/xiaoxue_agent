...
export type ConfigV2ExperimentalPolicy = {
    action: 'provider.use' | 'model.use' | 'mcp.use' | 'skill.use' | 'plugin.use' | 'connector.use' | 'directory.read' | 'directory.write' | 'knowledge.read' | 'knowledge.write' | 'network.host' | 'archive.publish';
    effect: PolicyEffect;
    resource: string;
};
...
export type ConfigXiaoxueMemoryForgetResponse = ConfigXiaoxueMemoryForgetResponses[keyof ConfigXiaoxueMemoryForgetResponses];
...
export type ConfigXiaoxueMemoryUpdateResponse = ConfigXiaoxueMemoryUpdateResponses[keyof ConfigXiaoxueMemoryUpdateResponses];
...
export type ConfigXiaoxueMemoryHistoryResponse = ConfigXiaoxueMemoryHistoryResponses[keyof ConfigXiaoxueMemoryHistoryResponses];
