...
export class Skills extends HeyApiClient {
     ...
     */
    public importPreview<ThrowOnError extends boolean = false>(parameters?: {
        source?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'body', key: 'source' }] }]);
        return (options?.client ?? this.client).post<AppSkillsImportPreviewResponses, AppSkillsImportPreviewErrors, ThrowOnError>({
    ...
    public conflicts<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
        return (options?.client ?? this.client).get<AppSkillsConflictsResponses, AppSkillsConflictsErrors, ThrowOnError>({ url: '/skill/conflicts', ...options });
    }
}
...
export class Models extends HeyApiClient {
    ...
    public list<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
        return (options?.client ?? this.client).get<GlobalModelsListResponses, GlobalModelsListErrors, ThrowOnError>({ url: '/global/models', ...options });
    }
    ...
    public create<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
        return (options?.client ?? this.client).post<GlobalModelsCreateResponses, GlobalModelsCreateErrors, ThrowOnError>({ url: '/global/models', ...options });
    }
     ...
     */
    public references<ThrowOnError extends boolean = false>(parameters: {
        key: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'key' }] }]);
        return (options?.client ?? this.client).get<GlobalModelsReferencesResponses, GlobalModelsReferencesErrors, ThrowOnError>({
     ...
     */
    public test<ThrowOnError extends boolean = false>(parameters: {
        key: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'key' }] }]);
...
export class Config2 extends HeyApiClient {
     ...
     */
    public xiaoxueMemory<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'query', key: 'workspace' }] }]);
     ...
     */
    public xiaoxueMemoryForget<ThrowOnError extends boolean = false>(parameters: {
        id: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).delete<ConfigXiaoxueMemoryForgetResponses, ConfigXiaoxueMemoryForgetErrors, ThrowOnError>({
     ...
     */
    public xiaoxueMemoryUpdate<ThrowOnError extends boolean = false>(parameters: {
        id: string;
        directory?: string;
        workspace?: string;
        content?: string;
        ...
        return (options?.client ?? this.client).patch<ConfigXiaoxueMemoryUpdateResponses, ConfigXiaoxueMemoryUpdateErrors, ThrowOnError>({
            url: '/config/xiaoxue/memory/{id}',
            ...options,
            ...params,
            headers: {
     ...
     */
    public xiaoxueMemoryHistory<ThrowOnError extends boolean = false>(parameters: {
        id: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        ...
        return (options?.client ?? this.client).get<ConfigXiaoxueMemoryHistoryResponses, ConfigXiaoxueMemoryHistoryErrors, ThrowOnError>({
     ...
     */
    public xiaoxueKnowledge<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>) {
        const params = buildClientParams([parameters], [{ args: [{ in: 'query', key: 'directory' }, { in: 'query', key: 'workspace' }] }]);
        return (options?.client ?? this.client).get<ConfigXiaoxueKnowledgeResponses, ConfigXiaoxueKnowledgeErrors, ThrowOnError>({
