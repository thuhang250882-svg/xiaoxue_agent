export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u 录井小雪-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u 录井小雪-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u 录井小雪-u.",
  ...
  "dialog.server.description": "Promijeni na koji se 录井小雪 server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera 录井小雪 u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje 录井小雪 u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj 录井小雪 u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj 录井小雪 u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi 录井小雪 mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori 录井小雪.",
  ...
  "toast.update.description": "Nova verzija 录井小雪-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku 录井小雪 timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: 录井小雪 još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni 录井小雪 server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u 录井小雪-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako 录井小雪 izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li 录井小雪 prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu 录井小雪-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se 录井小雪 pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju 录井小雪-a.",
  ...
  "session.header.reveal.containingFolder": "Otvori sadržajni folder",
