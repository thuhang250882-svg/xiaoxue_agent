export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en 录井小雪.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de 录井小雪 se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando 录井小雪 en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando 录井小雪 en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza 录井小雪 en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala 录井小雪 en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que 录井小雪 pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir 录井小雪.",
  ...
  "toast.update.description": "Una nueva versión de 录井小雪 ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de 录井小雪",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, 录井小雪 no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor 录井小雪 dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para 录井小雪",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve 录井小雪 en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si 录井小雪 sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de 录井小雪.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia 录井小雪",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de 录井小雪.",
