export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i 录井小雪.",
  ...
  "dialog.server.description": "Skift hvilken 录井小雪-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker 录井小雪 i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer 录井小雪 i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater 录井小雪 i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før 录井小雪 kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter 录井小雪 igen.",
  ...
  "toast.update.description": "En ny version af 录井小雪 ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til 录井小雪-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, 录井小雪 understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør 录井小雪-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for 录井小雪",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan 录井小雪 ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om 录井小雪 følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan 录井小雪 er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når 录井小雪 starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af 录井小雪.",
