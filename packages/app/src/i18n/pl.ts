export const dict = {
  ...
  "dialog.provider.custom.label": "Niestandardowy dostawca kompatybilny z OpenAI",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w 录井小雪.",
  ...
  "dialog.server.description": "Przełącz serwer 录井小雪, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie 录井小雪 w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie 录井小雪 w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj 录井小雪 w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj 录井小雪 w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim 录井小雪 będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz 录井小雪.",
  ...
  "toast.update.description": "Nowa wersja 录井小雪 ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu 录井小雪",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: 录井小雪 nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "录井小雪 zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer 录井小雪 wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla 录井小雪",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd 录井小雪 na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy 录井小雪 ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw 录井小雪.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania 录井小雪",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji 录井小雪.",
