export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "录井小雪が提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、录井小雪で{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続して录井小雪で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、录井小雪で{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続する录井小雪サーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "录井小雪を確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内の录井小雪を確認中...",
  "wsl.onboarding.updatingOpencode": "录井小雪を更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内の录井小雪を更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内の录井小雪を更新してください。",
  "wsl.onboarding.updateOpencode": "录井小雪を更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内の录井小雪の準備ができました。",
  "wsl.onboarding.opencodeReady": "录井小雪の準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}に录井小雪をインストールしてください。",
  "wsl.onboarding.installOpencode": "录井小雪をインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪がインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "录井小雪でWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、录井小雪をもう一度開いてください。",
  ...
  "toast.update.description": "录井小雪の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを录井小雪チームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: 录井小雪はまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "录井小雪には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境で录井小雪サーバーを実行します。",
  ...
  "settings.general.row.language.description": "录井小雪の表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでの录井小雪の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "录井小雪がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "录井小雪のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "录井小雪 の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "录井小雪 は最新バージョンです。",
  ...
  "session.header.reveal.finder": "Finder に表示",
