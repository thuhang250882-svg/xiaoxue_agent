export const dict = {
  ...
  "dialog.provider.custom.label": "مزود مخصص متوافق مع OpenAI",
  "dialog.model.unpaid.viewMoreProviders": "اطلع على أكثر من 70 مزودًا إضافيًا",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك 录井小雪 Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في 录井小雪.",
  ...
  "dialog.server.description": "تبديل خادم 录井小雪 الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من 录井小雪 في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث 录井小雪 في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث 录井小雪 في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت 录井小雪 في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن 录井小雪 من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على 录井小雪 التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح 录井小雪.",
  ...
  "toast.update.description": "نسخة جديدة من 录井小雪 ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق 录井小雪",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن 录井小雪 لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن 录井小雪 نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم 录井小雪 داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ 录井小雪",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور 录井小雪 على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان 录井小雪 يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة 录井小雪.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل 录井小雪",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من 录井小雪.",
