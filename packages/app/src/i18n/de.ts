...
export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "Weitere 70+ Anbieter ansehen",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 录井小雪 zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in 录井小雪 zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 录井小雪 zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den 录井小雪-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "录井小雪",
  ...
  "wsl.onboarding.checkingOpencode": "录井小雪 wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "录井小雪 in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "录井小雪 wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "录井小雪 in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie 录井小雪 in {{distro}}.",
  "wsl.onboarding.updateOpencode": "录井小雪 aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "录井小雪 ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie 录井小雪 in {{distro}}.",
  "wsl.onboarding.installOpencode": "录井小雪 installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor 录井小雪 einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann 录井小雪 erneut.",
  ...
  "toast.update.description": "Eine neue Version von 录井小雪 ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem 录井小雪-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: 录井小雪 unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "录井小雪-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für 录井小雪 ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie 录井小雪 auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob 录井小雪 dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von 录井小雪 anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von 录井小雪 automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von 录井小雪.",
