export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans 录井小雪.",
  ...
  "dialog.server.description": "Changez le serveur 录井小雪 auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'录井小雪 dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'录井小雪 dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour 录井小雪 dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez 录井小雪 dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'录井小雪 puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez 录井小雪.",
  ...
  "toast.update.description":
    "Une nouvelle version d'录井小雪 ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe 录井小雪",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'录井小雪 ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "录井小雪 inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur 录井小雪 dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour 录井小雪",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'录井小雪 sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si 录井小雪 suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'录井小雪.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'录井小雪",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'录井小雪.",
