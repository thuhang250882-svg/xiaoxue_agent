...
export const dict = {
  ...
  "dialog.model.unpaid.viewMoreProviders": "70+ sağlayıcıyı daha gör",
  ...
  "dialog.model.unpaid.freeModels.title": "录井小雪 tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve 录井小雪'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak 录井小雪'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak 录井小雪'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi 录井小雪 sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "录井小雪 kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde 录井小雪 kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "录井小雪 güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde 录井小雪 güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki 录井小雪'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "录井小雪'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde 录井小雪 hazır.",
  "wsl.onboarding.opencodeReady": "录井小雪 hazır.",
  "wsl.onboarding.installOpencodeIn": "录井小雪'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "录井小雪'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "录井小雪'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından 录井小雪'u tekrar açın.",
  ...
  "toast.update.description": "录井小雪'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı 录井小雪 ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: 录井小雪 henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "录井小雪 Masaüstü",
  ...
  "settings.desktop.wsl.description": "录井小雪 sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "录井小雪'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "录井小雪'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "录井小雪'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "录井小雪'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "录井小雪 başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "录井小雪'un en son sürümünü kullanıyorsunuz.",
