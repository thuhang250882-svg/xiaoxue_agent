...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i 录井小雪.",
  ...
  "dialog.server.description": "Bytt hvilken 录井小雪-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av 录井小雪 ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til 录井小雪-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at 录井小雪 ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør 录井小雪-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for 录井小雪",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan 录井小雪 ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om 录井小雪 skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan 录井小雪 er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når 录井小雪 starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av 录井小雪.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker 录井小雪 i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer 录井小雪 i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater 录井小雪 i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "录井小雪 er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "录井小雪 er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer 录井小雪 i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før 录井小雪 kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "录井小雪 kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter 录井小雪 på nytt.",
