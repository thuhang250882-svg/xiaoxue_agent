export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo 录井小雪",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no 录井小雪.",
  ...
  "provider.connect.opencodeZen.line1":
    "录井小雪 Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no 录井小雪.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no 录井小雪.",
  ...
  "dialog.server.description": "Trocar para qual servidor 录井小雪 este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o 录井小雪 em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o 录井小雪...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o 录井小雪 em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o 录井小雪 em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o 录井小雪",
  "wsl.onboarding.opencodeReadyIn": "O 录井小雪 está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O 录井小雪 está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o 录井小雪 em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "录井小雪 não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o 录井小雪 possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O 录井小雪 não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o 录井小雪 novamente.",
  ...
  "toast.update.description": "Uma nova versão do 录井小雪 ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do 录井小雪",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: 录井小雪 ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor 录井小雪 dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do 录井小雪",
  ...
  "settings.general.row.appearance.description": "Personalize como o 录井小雪 aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o 录井小雪 segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o 录井小雪 é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o 录井小雪 iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do 录井小雪.",
  ...
  "session.header.reveal.containingFolder": "Abrir pasta",
