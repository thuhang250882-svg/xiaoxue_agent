...
export const dict = {
  ...
  "dialog.provider.custom.label": "自訂 OpenAI 相容服務商",
  "dialog.model.unpaid.viewMoreProviders": "檢視 70+ 更多服務商",
  ...
  "dialog.model.unpaid.freeModels.title": "录井小雪 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 录井小雪 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "录井小雪 Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 录井小雪 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 录井小雪 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 录井小雪 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 录井小雪...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 录井小雪...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 录井小雪 已就緒。",
  "wsl.onboarding.opencodeReady": "录井小雪 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 录井小雪。",
  "wsl.onboarding.installOpencode": "安裝 录井小雪",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 录井小雪",
  ...
  "wsl.onboarding.wslUnavailable.description": "录井小雪 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 录井小雪。",
  ...
  "toast.update.description": "录井小雪 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 录井小雪 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: 录井小雪 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "录井小雪 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 录井小雪 伺服器。",
  ...
  "settings.general.row.language.description": "變更 录井小雪 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 录井小雪 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 录井小雪 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 录井小雪 的主題。",
  ...
  "settings.updates.row.startup.description": "在 录井小雪 啟動時自動檢查更新",
