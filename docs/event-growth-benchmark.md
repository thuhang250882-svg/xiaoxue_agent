...
## 基准结果（2026-08-04，Windows，Bun 1.3）
...
| **event data 持久化字节** | 5,160,400 | 258,382 | **-95.0%** |
| 数据库文件大小（含 checkpoint 后） | 15,413,248 B | 4,096 B | -99.97% |
| WAL 文件大小 | 4,161,232 B | 2,282,512 B | -45.1% |
| 首 Token 通知时间 | 6 ms | 0 ms | 无劣化 |
| 流总耗时 | 15,703 ms | 15,558 ms | 无劣化 |
...
| 持久化字节减少 | ≥ 90% | 95.0%（5,160,400 → 258,382 B） | ✅ |
